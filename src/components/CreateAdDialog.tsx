        ...
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          ...
          <div className="flex gap-6">
            ...
            <div className="flex flex-col gap-2 flex-2">
              <label htmlFor="hourStart">Que horas você começa a jogar?</label>
          ...
          <label className="mt-2 flex gap-2 items-center">
            <Checkbox.Root
              ...
              className="bg-zinc-900 rounded w-5 h-5 flex items-center justify-center"
            >
              <Checkbox.Indicator>
                <Check className="w-4 h-4 rounded text-emerald-400" />
              </Checkbox.Indicator>
            </Checkbox.Root>
          ...
          <footer className="mt-4 flex justify-end gap-4">
            <button
              type="submit"
              className="bg-violet-500 px-5 h-12 rounded-lg font-semibold flex items-center gap-3 hover:bg-violet-900 "
            >
            ...
            <Dialog.DialogClose
              type="button"
              className="bg-zinc-500 px-5 h-12 rounded-lg font-semibold hover:bg-zinc-700"
            >
              Cancelar
            </Dialog.DialogClose>
          </footer>
